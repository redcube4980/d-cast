...
function skipScene(){
	...
	skipChara01 = $.cookie('d_cast_chara03_01');
	skipChara02 = $.cookie('d_cast_chara03_02');
	skipChara03 = $.cookie('d_cast_chara03_03');
...
function commentNext(){
	...
	//Cookieの設定	
	if(sceneNum == 10){
		$.cookie('d_cast_chara03_01','clear',{expires:30});
		$.cookie('d_cast_chara03_02','clear',{expires:30});
		$.cookie('d_cast_chara03_03','clear',{expires:30});
	}
	else if(sceneNum == 6){
		$.cookie('d_cast_chara03_01','clear',{expires:30});
		$.cookie('d_cast_chara03_02','clear',{expires:30});

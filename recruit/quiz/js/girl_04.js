...
function btnSetting(){
	...
	$("#answer1_2").click(function(){ngStart();});
	$("#answer1_3").click(function(){seikaiStart();});
	$("#answer2_1").click(function(){seikaiStart();});
	$("#answer2_2").click(function(){ngStart();});
	$("#answer2_3").click(function(){ngStart();});
	$("#answer3_1").click(function(){ngStart();});
	$("#answer3_2").click(function(){seikaiStart();});
	$("#answer3_3").click(function(){ngStart();});
...
function skipScene(){
	...
	skipChara01 = $.cookie('d_cast_chara04_01');
	skipChara02 = $.cookie('d_cast_chara04_02');
	skipChara03 = $.cookie('d_cast_chara04_03');
...
function commentNext(){
	...
	//Cookieの設定	
	if(sceneNum == 10){
		$.cookie('d_cast_chara04_01','clear',{expires:30});
		$.cookie('d_cast_chara04_02','clear',{expires:30});
		$.cookie('d_cast_chara04_03','clear',{expires:30});
	}
	else if(sceneNum == 6){
		$.cookie('d_cast_chara04_01','clear',{expires:30});
		$.cookie('d_cast_chara04_02','clear',{expires:30});
	...
	if(sceneNum == 1 && txtC1n == 2){
		QAnum=1;
		QATimer =setTimeout(function(){startQA();},800);
	}
	
	if(sceneNum == 12){//INDEXに戻る処理			
